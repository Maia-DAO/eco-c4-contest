...
library RewardMath {
     ...
     *                  assumed to be constant over the period over which the snapshots are measured
     * @param boostAmount The amount of boost tokens staked
     * @param boostTotalSupply The total amount of boost tokens staked
     * @param secondsPerLiquidityInsideInitialX128 The seconds per liquidity of the liquidity tick range
     *                                             as of the beginning of the period
     * @param secondsPerLiquidityInsideX128 The seconds per liquidity of the liquidity tick range
     *                                      as of the current block timestamp
     * @return boostedSecondsInsideX128 The total liquidity seconds inside the position's range
     *                                  for the duration of the stake, adjusted to account for boost
     */
